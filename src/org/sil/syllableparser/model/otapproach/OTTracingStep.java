...
public class OTTracingStep {
	...
	public OTTracingStep(Segment segment, NPSyllabificationStatus status) {
		super();
		this.segment1 = segment;
		this.status = status;
	}

	public OTTracingStep(Segment segment1, SHNaturalClass naturalClass1, Segment segment2,
