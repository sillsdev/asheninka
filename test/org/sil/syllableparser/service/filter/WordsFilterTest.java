...
public class WordsFilterTest extends ONCSyllabifierTestBase {
	...
	public void anywhereFilterTest() {
		...
		checkApplyFilter(wf, WordsFilterType.CORRECT, 737, "akemijantaperotero");
		...
		checkApplyFilter(wf, WordsFilterType.WORDS, 737, "akemijantaperotero");
		...
		checkApplyFilter(wf, WordsFilterType.CORRECT, 735, "akemijantaperotero");
		...
		checkApplyFilter(wf, WordsFilterType.WORDS, 735, "akemijantaperotero");
		...
		checkApplyFilter(wf, WordsFilterType.CORRECT, 4, "Tajorentsi");
		...
		checkApplyFilter(wf, WordsFilterType.WORDS, 4, "Tajorentsi");
	}
	...
	public void atEndFilterTest() {
		...
		checkApplyFilter(wf, WordsFilterType.CORRECT, 67, "ijeekakinta");
		...
		checkApplyFilter(wf, WordsFilterType.WORDS, 67, "ijeekakinta");
	...
	public void atStartFilterTest() {
		...
		checkApplyFilter(wf, WordsFilterType.CORRECT, 5, "Tajorentsi");
	...
	public void nonblanksFilterTest() {
		...
		checkApplyFilter(wf, WordsFilterType.CORRECT, 1716, "achariniiteni");
		...
		checkApplyFilter(wf, WordsFilterType.WORDS, 1716, "achariniiteni");
	}
	...
	public void wholeItemFilterTest() {
		...
		checkApplyFilter(wf, WordsFilterType.CORRECT, 2, "mon.kaa.ta.ka", "monkaataka");
		...
		checkApplyFilter(wf, WordsFilterType.WORDS, 2, "monkaataka", "monkaataka");
		
		// second set: case sensitive match of "ta"
		wf.setMatchCase(true);
		checkApplyFilter(wf, WordsFilterType.ONC_PREDICTED, 1, "mon.kaa.ta.ka", "monkaataka");
		checkApplyFilter(wf, WordsFilterType.CORRECT, 1, "mon.kaa.ta.ka", "monkaataka");
		...
		checkApplyFilter(wf, WordsFilterType.WORDS, 1, "monkaataka", "monkaataka");
