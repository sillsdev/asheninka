...
import org.sil.syllableparser.service.comparison.DifferentCVNaturalClass;
import org.sil.syllableparser.service.comparison.DifferentCVSyllablePattern;
...
public class CVApproachLanguageComparerTest {
	...
	protected void compareWords(ApproachLanguageComparer comparer) {
		...
		listOfDiffs.addAll(diffs);
		DifferentWord diffWord = listOfDiffs.get(3167);
